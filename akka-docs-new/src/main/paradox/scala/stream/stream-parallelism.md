<a id="stream-parallelism-scala"></a>
...
@@snip [FlowParallelismDocSpec.scala](../code/docs/stream/FlowParallelismDocSpec.scala) { #pipelining }
...
@@snip [FlowParallelismDocSpec.scala](../code/docs/stream/FlowParallelismDocSpec.scala) { #parallelism }
...
@@snip [FlowParallelismDocSpec.scala](../code/docs/stream/FlowParallelismDocSpec.scala) { #parallel-pipeline }
...
@@snip [FlowParallelismDocSpec.scala](../code/docs/stream/FlowParallelismDocSpec.scala) { #pipelined-parallel }
