...
actor. There are specialized tools available as described in @ref:[Testing Finite State Machines](testing.md#testfsmref)
...
[Akka FSM in Scala](http://www.lightbend.com/activator/template/akka-sample-fsm-scala)
